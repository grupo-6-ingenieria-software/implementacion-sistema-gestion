...
export async function validateLotBasicsInSql(
  ...
  if (!result.ean13Valid)
    errors.ean13 = "Seleccione un producto activo para registrar el lote.";
  if (!result.quantityValid)
    errors.cantidad = "La cantidad debe ser un entero mayor que 0.";
  if (!result.costValid)
    errors.precioCosto = "El costo del lote debe ser un entero mayor que 0.";
